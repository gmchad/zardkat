...
```
**adding contracts**   
To add a new contract, add another object to the circuits array with paths to the contract. For sake of standardization you can find and replace the **name** for each parameter
